...
<td colspan='2'>
<?
$categories=request("select $TBL_news_categories.id,$TBL_news_categories.contain_items, $TBL_news_categories.id_parent, $TBL_news_categories.ordering, $TBL_news_info_categories.name, $TBL_news_info_categories.description from  $TBL_news_categories,$TBL_gen_languages,$TBL_news_info_categories where $TBL_news_info_categories.id_news_cat=$TBL_news_categories.id and $TBL_news_info_categories.id_language=$TBL_gen_languages.id and $TBL_gen_languages.id='$used_language_id' order by $TBL_news_categories.id_parent, $TBL_news_categories.ordering", $link);
...
if($nbCategories) {
	...
	echo showNews($tableCategories,0,$idCat,0,"./list_news.php?idCat=",true,$link);
