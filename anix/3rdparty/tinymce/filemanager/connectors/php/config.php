...
if(isset($_SESSION["managedWebsite_URIPath"])) $PathPrepend = $_SESSION["managedWebsite_URIPath"];
else $PathPrepend="";
...
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = $PathPrepend."/UserFiles" ;
/*==============================================================================*/
...
$fckphp_config['uploadProgressHandler']=""; //Perl upload progress handler
...
$fckphp_config['ResourceAreas']['File'] =array(
	...
	'AllowedExtensions'	=>	array("zip","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","swf","fla","ppt"),
...
$fckphp_config['ResourceAreas']['Media'] =array(
	'AllowedExtensions'	=>	array("swf","fla","jpg","gif","jpeg","png","avi","mpg","mpeg","ppt"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	5120,
	'DiskQuota'		=>	-1,
	'HideFolders'		=>	array("^\."),
