...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwDrag                = 'Cliquez ici pour déplacer';
             scwArrMonthNames       = ['Jan','Fev','Mar','Avr','Mai','Jun',
                                       'Jul','Aou','Sep','Oct','Nov','Dec'];
             scwArrWeekInits        = ['D','L','Ma','Me','J','V','S'];
             scwInvalidDateMsg      = 'La date saisie est invalide.\n';
             scwOutOfRangeMsg       = 'The entered date is out of range.';
             scwDoesNotExistMsg     = 'La date entrée n\'existe pas.';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #608598;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwInputDate            {background-color:  #d6e0e4;'   +
                                        'color:             #30507A;}'  +
            '/* Weekend Day */'                                         +
    ...
    function scwShow(scwEle,scwSourceEle)
        {scwTriggerEle = scwSourceEle;
         ...
         var offsetTop =parseInt(scwEle.offsetTop ,10) +
             ...
             offsetLeft=parseInt(scwEle.offsetLeft-70,10);
