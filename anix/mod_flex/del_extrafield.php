...
setTitleBar(_("Suppression d'un champs additionnel d'éléments"));
?>
...
<tr>
  ...
  if($extraField->id_cat){
  	echo "<I>"._("NB: Les informations contenues dans ce champs seront également supprimées pour tous les éléments de la catégorie!")."</I>";
  }
  ?><br />
  </b></center>
  </td>
