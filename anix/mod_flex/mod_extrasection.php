...
if($action=="edit") {
	...
	$result=request("select $TBL_lists_extracategorysection.id,$TBL_lists_extracategorysection.id_cat,$TBL_lists_info_extracategorysection.name from $TBL_lists_extracategorysection,$TBL_lists_info_extracategorysection,$TBL_gen_languages where $TBL_lists_extracategorysection.id=$idExtraSection and $TBL_gen_languages.id='$used_language_id' and $TBL_lists_info_extracategorysection.id_extrasection=$TBL_lists_extracategorysection.id and $TBL_lists_info_extracategorysection.id_language=$TBL_gen_languages.id",$link);
...
<td colspan='2'>
    ...
    <?
    if($action=="edit"){
    	$languages=request("SELECT $TBL_gen_languages.image_file,$TBL_gen_languages.locales_folder,$TBL_gen_languages.id,$TBL_lists_info_extracategorysection.name extrasection FROM `$TBL_gen_languages`,`$TBL_lists_info_extracategorysection` WHERE $TBL_gen_languages.used ='Y' and $TBL_lists_info_extracategorysection.id_extrasection='$idExtraSection' and $TBL_lists_info_extracategorysection.id_language=$TBL_gen_languages.id ORDER BY $TBL_gen_languages.id!='$used_language_id',$TBL_gen_languages.default",$link);
    } elseif($action=="add") {
