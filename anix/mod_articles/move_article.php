...
?>
<?
$title = _("Anix - Déplacement d'un article");
include("../html_header.php");
setTitleBar(_("Déplacement d'un article"));
?>
...
?>
  <TR>
    ...
    ?>
      <CENTER>
        <B><?php echo _("Veuillez sélectionner la catégorie dans laquelle vous souhaitez déplacer l'article suivant"); ?>:</B>
      </CENTER>
      <BR>
      <BR>
...
echo showCategories($tableCategories,0,0,"./list_articles.php?action=move&idArticle=$idArticle&moveto=",false,true,$article->id_category);
      ?>
<?
    } //else !$article
      ?>
