...
?>
<?
$title = _("Anix - Copie d'une question");
include("../html_header.php");
setTitleBar(_("Copie d'une question"));
...
?>
  <TR>
    ...
    ?>
      <CENTER>
        <B><?php echo _("Veuillez sélectionner la catégorie dans laquelle vous souhaitez copier la question suivante:");?></B>
      </CENTER>
      <BR>
      <BR>
...
echo showCategories($tableCategories,0,0,"./list_faq.php?action=copy&idFaq=$idFaq&copyto=",false,true);
      ?>
<?
    } //else !$faq
      ?>
