<?php
  ...
  class topDealsList{
    ...
    //constructors
    function topDealsList($idCategory,$idLanguage,$idGroup,$link){
      ...
      $requestString="SELECT $TBL_catalogue_info_products.name,
                ...
                $TBL_catalogue_products.featured,
          ...
          WHERE $TBL_catalogue_products.featured='Y'
      ...
      while($row=mysql_fetch_object($request)){
        ...
        $this->productTable[$row->id]["is_featured"]=$row->featured=="Y";
